...
class PGLAuthClient:
    ...
    def register(self, matricula: str, senha: str) -> None:
...
def register(matricula: str, senha: str, register_url: str | None = None) -> None:
    """Atalho para cadastrar a senha sem instanciar PGLAuthClient diretamente."""
    PGLAuthClient(register_url=register_url).register(matricula, senha)
